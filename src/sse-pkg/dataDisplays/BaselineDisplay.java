/*
 * Class that displays the Baseline Display.
 *
 * Project: OpenSonATA
 * Version: 1.0
 ...
 *          years.
 *
 * This class displays baseline display of SonATA data.
 *
...
public class BaselineDisplay extends JApplet implements ReadoutListener 
{
    ...
    int baselineCount;
    boolean useTimeAvg;
    static final int MAX_SUBBANDS = 4096;
     ...
     * else use the default $HOME/sse_archive.
    ...
    private String getArchiveDir()
    {
        ...
        if (archiveDir == null)
        {
            archiveDir = env.getEnvVar("HOME") + "/sse_archive"; 
        }
        return archiveDir;
    }
